...
SIGNAL \u1|c~combout\ : std_logic;
SIGNAL \u2|c~combout\ : std_logic;
...
\u1|c\ : cycloneii_lcell_comb
-- Equation(s):
-- \u1|c~combout\ = \INPUT1~combout\ $ (\INPUT2~combout\)
...
PORT MAP (
	...
	combout => \u1|c~combout\);

-- Location: LCCOMB_X64_Y16_N10
\u2|c\ : cycloneii_lcell_comb
-- Equation(s):
-- \u2|c~combout\ = (\INPUT1~combout\ & \INPUT2~combout\)
