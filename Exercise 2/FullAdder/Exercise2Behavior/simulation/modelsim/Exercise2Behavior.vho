...
-- Equation(s):
-- \SUM~0_combout\ = \INPUT2~combout\ $ (\INPUT1~combout\ $ (\CARRY_IN~combout\))
...
-- Equation(s):
-- \CARRY_OUT~0_combout\ = (\INPUT2~combout\ & ((\INPUT1~combout\) # (\CARRY_IN~combout\))) # (!\INPUT2~combout\ & (\INPUT1~combout\ & \CARRY_IN~combout\))
