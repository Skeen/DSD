...
ARCHITECTURE structure OF Exercise2Structural IS
...
SIGNAL \u2|u1|c~0_combout\ : std_logic;
...
\u2|u1|c~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \u2|u1|c~0_combout\ = \INPUT2~combout\ $ (\INPUT1~combout\ $ (\CARRY_IN~combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \INPUT2~combout\,
	datac => \INPUT1~combout\,
	datad => \CARRY_IN~combout\,
	combout => \u2|u1|c~0_combout\);

-- Location: LCCOMB_X64_Y19_N26
\u3|c~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \u3|c~0_combout\ = (\INPUT2~combout\ & ((\INPUT1~combout\) # (\CARRY_IN~combout\))) # (!\INPUT2~combout\ & (\INPUT1~combout\ & \CARRY_IN~combout\))
